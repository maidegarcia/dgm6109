...
let routingNumber, transactionTypeValue, transactionTypeText, transactionLocationValue, transactionLocationText, confirmationCode, partialView, a, b, c;
...
function evaluateAnswers() {
    ...
    else if (transactionTypeValue == "2" && routingNumber != "000000204" && routingNumber != "000001193" && routingNumber != "000008002") {
        output("The routing number is incorrect for this type of transaction")
        valid = false;
    }
    ...
    else if (transactionTypeValue == "3" && routingNumber != "000090007") {
        output("The routing number is incorrect for this type of transaction")
        valid = false;
    }
    ...
    else if (transactionTypeValue == "4" && transactionLocationValue == "1" && routingNumber.slice(0, 4) != "0410" && routingNumber.slice(0, 4) != "0412") {
        output("The routing number is incorrect for this type of transaction")
        valid = false
    }

    else if (transactionTypeValue == "4" && transactionLocationValue == "2" && routingNumber.slice(0, 4) != "0711") {
        output("The routing number is incorrect for this type of transaction")

        valid = false;
    }

    else if (transactionTypeValue == "4" && transactionLocationValue == "3" && routingNumber.slice(0, 4) != "0710" && routingNumber.slice(0, 4) != "0712" && routingNumber.slice(0, 4) != "0719") {
        output("The routing number is incorrect for this type of transaction")
        valid = false;
